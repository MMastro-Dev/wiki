---
description: 'Use when writing or editing prose: wiki pages, README files, CV content, commit messages, blog posts, or any user-facing text'
applyTo: '**/*.md'
---
...
"commitment to", "dedication to", "passion for", "deep understanding", "proven track record" — prefer concrete evidence over these claims.
...
"ongoing initiatives", "despite challenges", "positioned to…"
