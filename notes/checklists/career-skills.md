# Career — Skills Development (Months 2–5)

**Goal:** Close the technical gaps between mid and senior/lead for the AI/platform target.
**Created:** 2026-05-28
**Status:** not-started
...
### Modern state management (applied in Projects C+D)

- [ ] Apply TanStack Query for server state in the C+D frontend
- [ ] Apply Zustand for client state where needed
...
- [ ] Core Web Vitals: LCP, CLS, INP — measurement and fix patterns
- [ ] Code splitting at route and feature level, lazy loading
- [ ] Node.js event loop, pino/Winston structured logging, OpenTelemetry basics

---

## Notes

- These are studied *alongside* project work (C+D), not before it. Learning by building.
- TypeScript and FastAPI depth are directly applied in Projects C+D.
- System design study feeds directly into interview prep (month 6+).
- See [notes/career-plan.md](../career-plan.md) § 9 for the full system design topic map.
